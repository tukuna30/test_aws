class ArticlesApi {  
    static getAllArticles() {
      return new Promise(function(resolve, reject) {
        let response = [{id: 1, name: 'Ladakh', description: "<h4>Picturesque Ladakh!!!</h4><p>Sometimes you like to be with nature. People are great but we do have internal solitary soul which needs moments to reflect. These reflections will help us to do more, feel and enjoy more about life, that is so beautiful.</p><p>&nbsp;</p><p>Let's plan for a road trip this July.&nbsp;</p>"}, 
